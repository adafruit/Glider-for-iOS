...
class AdafruitBoardsManager {
    ...
    */
    func startBoard(connectedBlePeripheral blePeripheral: BlePeripheral, services: [AdafruitBoard.BoardService]? = nil, completion: @escaping (Result<AdafruitBoard, Error>) -> Void) {
        ...
        adafruitBoard.setupPeripheral(blePeripheral: blePeripheral, services: services) { [weak self] result in
            ...
            case .success:
                ...
                completion(.success(adafruitBoard))
